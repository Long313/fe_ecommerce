...
function Modal() {
    ...
    return (<div className="p-[8px] rounded-[16px] fixed z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[30%] max-w-[896px] max-h-[606px] bg-white">
        ...
        <div className="mt-[20px] text-center text-[#030303] text-[20px] font-[500]">{t("checkMailTitle")}</div>
        ...
        <div className="mx-auto flex justify-between w-[70%] mt-[40px]">
            {otp.map((digit, index) => (
                <input
                    ...
                    className="text-[20px] outline-none inline-block border-b-[2px] border-[#822FFF] w-[18%] text-center"
                />
            ))}
        ...
        <div className="flex-col my-[30px] mx-auto flex justify-center items-center">
            ...
            <Button title={t("verifyOtp")} width="w-[80%]" height="h-[34px]" rounded="rounded-[12px]" onSubmit={handleVerifyOtp} boxShadow="shadow-[0px_7.12px_7.12px_0px_rgba(55,55,55,0.25)]" />
