...
export default function ProductDetail() {
    ...
    const handleAddToBag = () => {
        ...
        // Kiểm tra sản phẩm trùng id + size
        ...
        if (existingIndex !== -1) {
            ...
            // Thêm mới sản phẩm với quantity = 1
                ...
                <div className="relative w-[40%] shadow-[0_4px_12px_rgba(0,0,0,0.15)] p-[20px] flex flex-col items-center rounded-[4px]">
                    ...
                    <div className="flex justify-around items-center my-[10px]">
                        {COLORS.map((item) => (
                            <span
                                ...
                                className={`bg-[${item}] ${color === item ? "border-[2px] border-black" : ""} cursor-pointer border border-[#A3A3A3] w-[40px] h-[40px] mx-[4px] flex justify-center items-center rounded-[2px] hover:scale-102 hover:border-[1px] hover:border-black`}
                            >
                            </span>
                        ))}
                    </div>
                    ...
                    <div className='absolute top-[10px] -right-[30px] group overflow-visible'>
                        <div className="relative w-fit top-0 right-[40px]">
                            ...
                            >
                                {like ? <IoIosHeart size={20} className="hover:scale-105 cursor-pointer" onClick={handleAddToFavorite} color="red" /> : <IoIosHeartEmpty size={20} className="hover:scale-105 cursor-pointer" onClick={handleAddToFavorite} />}
